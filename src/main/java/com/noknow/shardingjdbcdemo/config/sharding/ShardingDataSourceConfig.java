...
@MapperScan(basePackages = "com.noknow.shardingjdbcdemo.repository.mysql.sharding.mapper",
...
public class ShardingDataSourceConfig {
  ...
  //@Primary
  public DataSource shardingDatasource(@Qualifier("primaryDataSource") HikariDataSource dataSource,
    ...
    //单数据源
    Map<String, DataSource> dataSourceMap = MapUtil.of("test_database", dataSource);
